...
function MessagePacker(e){function t(e,t){e.stored=!0;var r={message:e,timeout:setTimeout(function(){clearTimeout(r.timeout),delete s[t]},BASE_TIMEOUT)};s[t]=r}var r=0,a={},s={};this.pack=function(t){var a=new Array(6),s=t.type;switch(s){case"presence":a[0]=PRESENCE;break;case"offer":a[0]=OFFER;break;case"answer":a[0]=ANSWER;break;default:var i=Error("Unknown message type '"+s+"'");throw i.message=t,i}if(a[1]=t.from||e,a.type!=PRESENCE){var n=t.id||r++;a[2]=t.dest,a[3]=n,a[4]=Math.min(t.ttl||MAX_TTL_DEFAULT,MAX_TTL_DEFAULT),a[5]=t.sdp}return a},this.unpack=function(e){var r={},i=e[0];switch(i){case PRESENCE:r.type="presence";break;case OFFER:r.type="offer";break;case ANSWER:r.type="answer";break;default:var n=Error("Unknown message type '"+i+"'");throw n.message=e,n}r.from=e[1],i!=PRESENCE&&(r.dest=e[2],r.id=e[3],r.ttl=e[4],r.sdp=e[5]);var o=r.from,c=r.id;if("offer"==r.type){var f=s[o];if(f){var e=f.message;if(e.id>c)return;if(clearTimeout(f.timeout),delete s[o],e.id==c)return t(e,o),e}}if("answer"==r.type){var u=a[o];if(u){var E=u[c];if(E)return E.callback(n,r),void 0}}return r},this.presence=function(){var e=this.pack({type:"presence"});return e},this.offer=function(e,t,r){function s(t,s){clearTimeout(c.timeout),delete n[o],Object.keys(n).length||delete a[e],r(t,s)}var i=this.pack({type:"offer",dest:e,sdp:t});if(r)var n=a[e]=a[e]||{},o=i.id,c=n[o]={callback:s,timeout:setTimeout(function(){var e=new Error("Timed Out");e.request=i,s(e)},BASE_TIMEOUT)};return i},this.answer=function(e,r,a){var s=this.pack({type:"answer",dest:e,id:r,sdp:a});return t(s,e),s}}const PRESENCE=0,OFFER=1,ANSWER=2,MAX_TTL_DEFAULT=5,BASE_TIMEOUT=5e3;module.exports=MessagePacker;
},{}],2:[function(require,module,exports){
function applyChannelsShim(n){function a(n,a){Object.defineProperty(n,"starter",{value:a}),e.push(n),n.addEventListener("close",function(){e.splice(e.indexOf(n),1)})}if(void 0==n.getDataChannels){var e=[];n.getDataChannels=function(){return e};var t=n.dispatchEvent;n.dispatchEvent=function(n){if("datachannel"==n.type){var e=n.channel;a(e,!1)}t.call(this,n)};var l=n.createDataChannel;n.createDataChannel=function(n,e){var c=l.call(this,n,e);a(c,!0);var i=new Event("datachannel");i.channel=c,t.call(this,i)}}}module.exports=applyChannelsShim;
},{}],3:[function(require,module,exports){
function WebP2P(e){function n(e){c.emit("error",new Error(e))}function o(e,n,o){var t=new RTCPeerConnection({iceServers:[{url:"stun:"+d}]},{optional:[{DtlsSrtpKeyAgreement:!0}]});return applyChannelsShim(t),c.emit("peerconnection",t),t.createDataChannel(c.routingLabel),t.addEventListener("icecandidate",function(e){if(!e.candidate){var t=this.localDescription.type,s=this.localDescription.sdp;t==n?o(s):console.error(t+" SDP type is not equal to "+n+" callback type")}}),t.addEventListener("signalingstatechange",function(){"open"==t.signalingState&&v.add(e,t)}),t}function t(e,o){o=f.concat(o);for(var t,s=0;t=o[s];s++)e.createDataChannel(t);var r={mandatory:{OfferToReceiveAudio:!1,OfferToReceiveVideo:!1}};e.createOffer(function(o){e.setLocalDescription(o,function(){console.log("Offer LocalDescription created and set")},n)},n,r)}function s(e,o){e.setRemoteDescription(new RTCSessionDescription({sdp:o,type:"offer"}),function(){e.createAnswer(function(o){e.setLocalDescription(o,function(){console.log("Answer LocalDescription created and set")},n)},n)},n)}function r(e,n){if(--e.ttl<=0)return console.warning("TTL achieved: "+e),void 0;var o=e.dest;e=l.pack(e);for(var t,s=0;t=v._connectors[s];s++)if(t.sessionID===o)return t.send(e),void 0;v.send(e,n),p.send(e,n)}function i(e){e.on("connected",function(){p.status!=v.status&&c.emit("connected")}),e.on("disconnected",function(){p.status==v.status&&c.emit("disconnected")}),e.on("error",function(e){c.emit("error",e)}),e.on("offer",function(e,n){var t=e.from,i=e.dest;if(t!=c.sessionID)if(i==c.sessionID){console.log("["+c.sessionID+"] Received connection request from "+t);var a=e.id,f=o(t,"answer",function(e){var o=l.answer(t,a,e);n.send(o)});s(f,e.sdp)}else r(e,n)}),e.on("answer",function(e,o){var t=e.from,s=e.dest;if(t!=c.sessionID)if(s==c.sessionID){console.log("["+c.sessionID+"] Received connection response from "+t);var i=v.get(t);i?(i.setRemoteDescription(new RTCSessionDescription({sdp:sdp,type:"answer"}),function(){console.log("Successfuly generated RemoteDescription for "+t)},n),o.increaseConnections()):console.warn("["+c.sessionID+"] Connection with peer '"+t+"' was not previously requested")}else r(e,o)})}var c=this,a=function g(e){return e?(e^16*Math.random()>>e/4).toString(16):([1e7]+-1e3+-4e3+-8e3+-1e11).replace(/[018]/g,g)},e=e||{},f=e.commonLabels||[],u=e.handshake_servers,d=e.stun_server||"stun.l.google.com:19302";Object.defineProperty(this,"routingLabel",{value:e.routingLabel||"webp2p"}),Object.defineProperty(this,"sessionID",{value:e.sessionID||a()});var l=new MessagePacker(this.sessionID),p=new HandshakeManager(l,u),v=new PeersManager(l,c.routingLabel);this.__defineGetter__("status",function(){return"connected"==v.status?"connected":p.status}),this.connectTo=function(e,n,s){if(e==c.sessionID)return s(new Error("Connecting to ourself")),void 0;var r=v.get(e);r?s(null,r):(r=o(e,"offer",function(n){var o=l.offer(e,n,s);p.send(o),v.send(o)}),t(r,n))},i(p),i(v),p.on("presence",function(e,n){if(e!=c.sessionID){var s=v.get(e);if(!s){var r=o(e,"offer",function(o){var t=l.offer(e,o);n.send(t)});t(r)}}}),this.close=function(){p.close(),v.close()},window&&window.addEventListener("beforeunload",function(){c.close()})}var EventEmitter=require("events").EventEmitter,HandshakeManager=require("./managers/HandshakeManager"),PeersManager=require("./managers/PeersManager"),MessagePacker=require("./MessagePacker"),applyChannelsShim=require("./PeerConnection_channels.shim"),RTCPeerConnection=RTCPeerConnection||webkitRTCPeerConnection;WebP2P.prototype.__proto__=EventEmitter.prototype,WebP2P.prototype.constructor=WebP2P,module.exports=WebP2P;
...
function PeersManager(e,n){function a(e){var n=new Connector_DataChannel(e);return this._initConnector(n),n}Manager.call(this,e);var r={};this.add=function(e,t){t.addEventListener("signalingstatechange",function(){"closed"==t.signalingState&&delete r[e]});for(var o,i=t.getDataChannels(),s=0;o=i[s];s++)if(o.label==n){a(o);break}r[e]=t},this.get=function(e){return r[e]}}var Manager=require("./Manager"),Connector_DataChannel=require("../connectors/core/DataChannel");PeersManager.prototype.__proto__=Manager.prototype,PeersManager.prototype.constructor=PeersManager,module.exports=PeersManager;
