...
function()
{
  ...
  createPeer_connect([], 0, 5)
});


/*
asyncTest("Exchange data between two peers connected using a another four as intermediaries",
function()
{
  expect(21);
    ...
    conns[1].on('peersManager.connected', function(_peersManager)
    {
      ...
      conns[2].on('peersManager.connected', function(_peersManager)
      {
        ...
        conns[3].on('peersManager.connected', function(_peersManager)
        {
          ...
          conns[3].connectTo(conns[0].sessionID, function(error, peerconnection)
          {
