...
var template = '/*! datachannel.%ext% build:' + package.version +
    ', %type%. Copyright(c) 2013 Jesús Leganés Combarro "Piranna" <piranna@gmail.com> */'
  , prefix = '\n(function(exports){\n'
...
/**
 * If statements, these allows you to create server side & client side
 * compatible code using specially designed `if` statements that remove server
 * side designed code from the source files
 *
 * @api private
 */
 ...
 * @callback {String|Boolean} err An optional argument, if it exists than an
...
var builder = module.exports = function () {
  ...
  libs.forEach(function (file) {
    files.push(__dirname + LIB_FOLDER + file);
  });
